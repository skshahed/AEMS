...
<body>
	...
	<table align="center" width="550" border="0" bgcolor="#00CCFF" style="border:ridge; border-color:gray; border-radius:10px;" cellspacing="2" cellpadding="3">
	 <tr>
	   <th align="center" colspan="5" height="40px" style="font-size:18px"><b><u>My Previous Project</u></b></th>
   </tr>
	 <tr> <td>&nbsp;</td>
...
if(isset($_SESSION['username']))
{
	...
	$result = mysql_query("SELECT * FROM project WHERE project.p_incharge = '$test' AND project.p_status= 'Closed'");
	...
	if($count==0)
	{
		echo '<tr>';
    		echo ' <td></td>';
    		echo '  <td width="450px" align="center">You have no Previous project</td>';
	...
	$result_a = mysql_query("SELECT * FROM project WHERE project.p_incharge = '$test' AND project.p_status= 'Closed' ORDER BY p_id DESC $max");
