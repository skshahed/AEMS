...
<div id="reg">		
   ...
   <form>     
	<table align="center" width="800px" border="1" bgcolor="#00CCFF" style="border:ridge; border-color:gray; border-radius:10px;" cellspacing="2" cellpadding="3">
	 <tr>
	   <th align="center" colspan="6" height="40px" style="font-size:18px"><b><u>Log Details</u></b></th>
   </tr>
...
//{
	...
	$result = mysql_query("SELECT * FROM log_details WHERE username='$test'");
...
if($count==0)
{
	echo'<tr height="50px"><td colspan="6" align="center">No Log Details</td></tr>';
}
