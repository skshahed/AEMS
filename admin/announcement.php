...
<?php
	...
	if(isset($_POST['subject']))
		...
		$sql="INSERT INTO announcement (subject, message) VALUES
			('$subject','$message')";
...
?>
	...
	<table align="center" width="550" border="0" bgcolor="#00CCFF" style="border:ridge; border-color:gray; border-radius:10px;" cellspacing="1" cellpadding="1">
	 <tr>
	   <th align="center" colspan="5" height="20px" style="font-size:25px"><b><u>New Announcement</u></b></th>
   </tr>
	 <tr> <td width="40px">&nbsp;</td>
 ...
 <tr>
  ...
  <tr>
	<td>&nbsp;</td>
	    <td align="left" height="20"><br><input type="submit" value="Publish">&nbsp; &nbsp;
