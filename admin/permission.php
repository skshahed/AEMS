...
<div id="reg">		
 ...
 <form action="view_permission.php" method="post">
	<table align="center" width="900px" border="1" bgcolor="#00CCFF" style="border:ridge; border-color:gray; border-radius:10px;" cellspacing="2" cellpadding="3">
	 <tr>
	   <th align="center" colspan="6" height="40px" style="font-size:18px"><b><u>Permission</u></b></th>
   </tr>
 
  <tr>
    	<td width="170px" height="30px" align="center"><b>Username</b></td>
		<td width="180px" height="30px" align="center"><b>Subject</b></td>
    	<td width="170px" height="30px" align="center"><b>Status</b></td>
        <td width="170px" height="30px" align="center"><b>Date</b></td>
...
//{
	...
	*/
	...
	$result_a = mysql_query("SELECT * FROM leave_request ORDER BY date DESC $max");
