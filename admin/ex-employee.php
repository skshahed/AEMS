...
if(isset($_SESSION['username']))
{
	...
	$result = mysql_query("SELECT username,state FROM profile WHERE state='Ex' ORDER BY username ASC");
	...
	echo '<tr>';
		...
		echo'<td align="left">';
			...
			echo'</td>';
    echo '</tr>';
	echo'<input type="hidden" name="state" value="Ex" />';
	
/*	echo '<tr>';
    	echo ' <td width="30px"></td>';
    	echo ' <td width="150px">Condition</td>';
		echo '<td align="left">:</td>';
		echo'<td align="left">';
